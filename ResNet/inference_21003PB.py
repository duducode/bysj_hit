...
pb_file_path = './pb/frozen_model_21003_149.pb'
pb_file_path2 = './pb/frozen_model_21003_151.pb'
pb_file_path3 = './pb/frozen_model_21003_157.pb'
pb_file_path4 = './pb/frozen_model_21003_163.pb'
...
def build_graph(num_classes=FLAGS.charset_size, top_k=5, is_train=True, is_test=False):
    ...
    if is_train:
        ...
        vali_probabilities = tf.nn.softmax(vali_net, name='probabilities')
...
def test():
    ...
    with tf.Session(graph=g1) as sess:
        ...
        constant_graph = graph_util.convert_variables_to_constants(sess, sess.graph_def, ["image_batch", "probabilities"])
    ...
    with tf.Session(graph=g2) as sess:
        ...
        constant_graph = graph_util.convert_variables_to_constants(sess, sess.graph_def,
                                                                   ["image_batch", "probabilities"])
        with tf.gfile.FastGFile(pb_file_path2, mode='wb') as f:
            f.write(constant_graph.SerializeToString())
    ...
    with tf.Session(graph=g3) as sess:
        ...
        constant_graph = graph_util.convert_variables_to_constants(sess, sess.graph_def,
                                                                   ["image_batch", "probabilities"])
        with tf.gfile.FastGFile(pb_file_path3, mode='wb') as f:
            f.write(constant_graph.SerializeToString())
    ...
    with tf.Session(graph=g4) as sess:
        ...
        constant_graph = graph_util.convert_variables_to_constants(sess, sess.graph_def,
                                                                   ["image_batch", "probabilities"])
        with tf.gfile.FastGFile(pb_file_path4, mode='wb') as f:
            f.write(constant_graph.SerializeToString())
