...
tf.app.flags.DEFINE_string('checkpoint_dir', './checkpoint21003_wubi_1/', 'the checkpoint dir')
...
tf.app.flags.DEFINE_string('log_dir', './log21003_wubi_1', 'the logging dir')
    ...
    with sess:
        ...
        while True:
            try:
                ...
                for m in range(0, len(train_labels_batch)):
                    train_labels_batch[m] = dict[line[train_labels_batch[m]+1][2:3]]
                #print(train_labels_batch)
                #print('after:', train_labels_batch)
                #print(train_labels_batch[0])
                #print(train_labels_batch[255])
                ...
                '''
                # if step % 10 == 0:
                #     logger.info("the step {0} takes {1} loss: {2}".format(step, end_time - start_time, loss_train))
