...
def vgg_arg_scope(weight_decay=2e-5):
...
def vgg_a(inputs,
  ...
  with tf.variable_scope(scope, 'vgg_a', [inputs], reuse=reuse) as sc:
    ...
    with slim.arg_scope([slim.conv2d, slim.max_pool2d],
      ...
      net = slim.repeat(inputs, 1, slim.conv2d, 32, [3, 3], scope='conv1')
