...
tf.app.flags.DEFINE_integer('charset_size', 79, "Choose the first `charset_size` character to conduct our experiment.")
...
# tf.app.flags.DEFINE_string('train_data_dir', '/home/wenhy/dataset/3755/train/', 'the train dataset dir')
# tf.app.flags.DEFINE_string('test_data_dir', '/home/wenhy/dataset/3755/test/', 'the test dataset dir')
# tf.app.flags.DEFINE_string('val_data_dir', '/home/wenhy/dataset/3755/val/', 'the val dataset dir')
...
# tf.app.flags.DEFINE_boolean('gray', True, "whether to change the rbg to gray")
# tf.app.flags.DEFINE_integer('max_steps',100000001, 'the max training steps ')
# tf.app.flags.DEFINE_integer('eval_steps', 111, "the step num to eval")
# tf.app.flags.DEFINE_integer('save_steps', 111, "the steps to save")
# tf.app.flags.DEFINE_integer('decay_step', 111, 'Number of decay-step')
#
tf.app.flags.DEFINE_string('checkpoint_dir', './checkpoint3755_79/', 'the checkpoint dir')
...
tf.app.flags.DEFINE_string('log_dir', './log3755_79', 'the logging dir')
...
tf.app.flags.DEFINE_string('mode', 'validation', 'Running mode. One of {"train", "validation", "test"}')
